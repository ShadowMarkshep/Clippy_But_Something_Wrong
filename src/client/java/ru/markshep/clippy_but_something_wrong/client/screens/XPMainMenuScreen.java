...
//TODO: переписать все формулы для лучшего понимания
public class XPMainMenuScreen extends Screen {
    ...
    protected void init() {
        assert client != null;
        this.addDrawableChild(new XpStartButton(0, this.height - 17, 55, 17));
        this.addDrawableChild(new IconButton(32, 8, 32, 32, id("screens/icons/singleplayer.png"), "singleplayer.exe", () -> this.client.setScreen(new SelectWorldScreen(this))));
        this.addDrawableChild(new IconButton(32, 64, 32, 32, id("screens/icons/multiplayer.png"), "multiplayer.exe", () -> this.client.setScreen(new MultiplayerScreen(this))));
        if (startMenuIsActive){
            this.addDrawableChild(new PowerOffButton(200 - 45 - 16 - client.textRenderer.getWidth(Text.of("Turn off")), this.height - 17 - 17, 16, 16));
            this.addDrawableChild(new StartMenuBlueButton(200 - 44 - 20 - client.textRenderer.getWidth(Text.of("MC Settings")), this.height - 200 - 21 + 32, id("screens/icons/settings.png"), "MC Settings", () -> this.client.setScreen(new OptionsScreen(this, this.client.options))));
        }
    }
