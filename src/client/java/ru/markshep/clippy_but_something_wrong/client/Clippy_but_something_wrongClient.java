...
import ru.markshep.clippy_but_something_wrong.client.utils.GameMode;
...
public class Clippy_but_something_wrongClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        CONFIG.gameMode = GameMode.NORMAL;
        CONFIG.save();
        ...
        User32Ext.INSTANCE.MessageBoxW(Pointer.NULL, new WString("Внимание! Мод находится в активной разработке\n" +
                "\n" +
                "Эта версия является ранней dev версией и может содержать критические баги, недоработанные функции и нестабильную работу. Используйте на свой страх и риск.\n" +
                "\n" +
                "Возможны:\n" +
